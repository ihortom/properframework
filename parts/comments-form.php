<form action="<?php echo site_url(); ?>/wp-comments-post.php" method="post" id="commentform">
    ...
    <p class="text-center"><small>Your e-mail will not be shared. All the fields are mandatory *</small></p>
    <div class="row large-uncollapse">
        <div class="medium-12 large-6 columns">
            <div id="contacts" class="row">
                <div id="name" class="medium-6 large-12 columns">
                    <label for="author"><?php _e('Name:','properweb'); ?> <?php if ($req) _e('*'); ?></label>
                    <input type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
                </div>

                <div id="email" class="medium-6 large-12 columns">
                    <label for="email"><?php _e('Email:','properweb'); ?> <?php if ($req) _e('*'); ?></label>
    ...
    <?php endif; ?>
        <div class="medium-12 large-6 columns">
            <div id="message">
                <label for="comment"><?php _e('Message:','properweb'); ?> *</label>
