...
<div id="gbook">
	<div id="respond">
		<h3><?php comment_form_title( __('LEAVE A NOTE IN THE GUEST BOOK') ); ?></h3>
	...
	<?php if ( have_comments() ) : ?>
		<div id="comments">	
			...
			<ul class="comment-list">
				<?php wp_list_comments('type=comment&callback=pwrf_gbook_comment'); //use custom comment list in functions.php ?>
			</ul>
		 ...
		 <?php else : // this is displayed if there are no comments so far ?>
			...
			<?php if ( comments_open() ) : ?>
				...
				<p>На данный момент в гостевой книге нет ни одной записи.</p>
